...
func TestParseTemplateString(t *testing.T) {
	...
	engine, _ := GetEngine(false, DEFAULT_DELIMS[0], DEFAULT_DELIMS[1])
...
func TestDelims(t *testing.T) {
	var engine Engine
	engine, _ = GetEngine(false, TEST_DELIMS[0], TEST_DELIMS[1])
...
//	engine, _ := GetEngine(DEFAULT_DELIMS[0], DEFAULT_DELIMS[1])
//	params := make(map[string]string)
