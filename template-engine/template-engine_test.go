...
func TestParseTemplateString(t *testing.T) {
	...
	out, _ := template_engine.ParseTemplateFile("test_fixtures/README.md.tpl", params)
...
func TestTemplateJson(t *testing.T) {
	...
	outJson, _ := template_engine.ParseTemplateFile("test_fixtures/README.md.tpl", varsJson)
